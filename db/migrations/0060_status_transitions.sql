...
FROM (
  ...
  VALUES
    ('SUBMITTED', 'ASSIGNED',
     'forward', 'captain',  false, false, false, NULL, 'request.assigned',
    ...
    ('QUOTATION_GIVEN', 'ORDER_CONFIRMED',
     'forward', 'any',      false, true,  false, NULL, 'request.order_confirmed',
    ...
    ('PENDING_CAPTAIN_APPROVAL', 'ORDER_EXECUTED_SUCCESSFULLY',
     'forward', 'captain',  false, false, false, NULL, 'request.installation_complete',
  ...
  -- HVA-141 rollback -1 (single backward step from each non-initial stage)
    ('ASSIGNED', 'SUBMITTED',
     'rollback', 'any', true, false, false, NULL, 'status_rolled_back',
     'Undo assignment'),
    ...
    ('PENDING_CAPTAIN_APPROVAL', 'INSTALLATION_CONFIGURATION_DONE',
     'rollback', 'captain', true, false, false, NULL, 'status_rolled_back',
