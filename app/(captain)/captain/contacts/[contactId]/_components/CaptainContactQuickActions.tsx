...
// =============================================================================
// HVA-73 PR 2 fixup: client-side quick-action cluster for the captain
// contact detail page.
// =============================================================================
//
// Previously inlined inside the server-component page; the onClick
// prevent-default handler in the underlying <a> tripped RSC's
// "Event handlers cannot be passed to Client Component props" guard
// (digest 4138657525). Extracted verbatim to its own 'use client'
// module — same UX, RSC-safe.
// =============================================================================
...
export function CaptainContactQuickActions({ name, phone, email }: Props) {
